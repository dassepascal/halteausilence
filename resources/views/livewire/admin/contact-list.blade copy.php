...
<div>
    ...
    <div class="bg-white rounded-lg shadow overflow-hidden">
        ...
        <div class="divide-y divide-gray-200">
            ...
            <div
                class="p-6 hover:bg-gray-50 {{ !$contact->is_read ? 'bg-blue-50 border-l-4 border-blue-500' : '' }}">
            ...
            <div class="space-y-4">
                ...
                <div>
                    ...
                    <div class="mt-1 p-3 bg-gray-50 rounded-md">
                        <p class="text-sm text-gray-900 whitespace-pre-wrap">{{ $selectedContact->message }}
                        </p>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <p class="mt-1 text-sm text-gray-900">
                        {{ $selectedContact->created_at->format('d/m/Y à H:i:s') }}
                    </p>
                </div>
            </div>
